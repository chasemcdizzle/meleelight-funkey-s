// UPTILT.c <- src/characters/fox/moves/UPTILT.js (M2 task 8)
#include "../moves.h"
...
static AsTri fx_init(MlSim *S, double p, const MlInputBuffer in[4],
  ...
  mv_assign_hitbox_id(S, p, "uptilt", 2, 2);
  mv_assign_hitbox_id(S, p, "uptilt", 3, 3);
  fx_main(S, p, in, 0);
  return AS_UNDEF;
}
...
const MlMoveDef fox_UPTILT = {"UPTILT", fx_init, fx_main, fx_interrupt, 0};
