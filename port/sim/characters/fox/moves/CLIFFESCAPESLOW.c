// CLIFFESCAPESLOW.c <- src/characters/fox/moves/CLIFFESCAPESLOW.js
...
const MlMoveDef fox_CLIFFESCAPESLOW = {"CLIFFESCAPESLOW", fx_init, fx_main,
                                       fx_interrupt, 0};
