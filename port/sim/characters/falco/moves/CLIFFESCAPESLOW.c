// CLIFFESCAPESLOW.c <- src/characters/falco/moves/CLIFFESCAPESLOW.js
...
const MlMoveDef falco_CLIFFESCAPESLOW = {"CLIFFESCAPESLOW", fc_init, fc_main,
                                       fc_interrupt, 0};
