// CLIFFGETUPSLOW.c <- src/characters/falco/moves/CLIFFGETUPSLOW.js
...
const MlMoveDef falco_CLIFFGETUPSLOW = {"CLIFFGETUPSLOW", fc_init, fc_main,
                                      fc_interrupt, 0};
