// GRAB.c <- src/characters/puff/moves/GRAB.js (M2 task 12)
#include "../moves.h"
...
static AsTri pf_init(MlSim *S, double p, const MlInputBuffer in[4],
  ...
  pf_assign_hitbox_id(S, p, "grab", 0, 0);
  pf_assign_hitbox_id(S, p, "grab", 1, 1);
  pf_main(S, p, in, 0);
  return AS_UNDEF;
}
...
const MlMoveDef puff_GRAB = {"GRAB", pf_init, pf_main, pf_interrupt, 0};
