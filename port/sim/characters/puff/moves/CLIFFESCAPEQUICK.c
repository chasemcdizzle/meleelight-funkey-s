// CLIFFESCAPEQUICK.c <- src/characters/puff/moves/CLIFFESCAPEQUICK.js (M2 task 12)
// pos t<15, setVelocities t<50, grounding at t===15.
#include "../moves.h"
...
const MlMoveDef puff_CLIFFESCAPEQUICK = {"CLIFFESCAPEQUICK", pf_init, pf_main, pf_interrupt, 0};
