// DOWNSMASH.c <- src/characters/puff/moves/DOWNSMASH.js (M2 task 12)
// randomShout fires in INIT; 4 hitboxes.
#include "../moves.h"
...
static AsTri pf_init(MlSim *S, double p, const MlInputBuffer in[4],
  ...
  pf_assign_hitbox_id(S, p, "dsmash", 0, 0);
  pf_assign_hitbox_id(S, p, "dsmash", 1, 1);
  pf_assign_hitbox_id(S, p, "dsmash", 2, 2);
  pf_assign_hitbox_id(S, p, "dsmash", 3, 3);
...
const MlMoveDef puff_DOWNSMASH = {"DOWNSMASH", pf_init, pf_main, pf_interrupt, 0};
