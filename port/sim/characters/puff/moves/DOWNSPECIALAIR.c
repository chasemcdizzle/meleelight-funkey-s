// DOWNSPECIALAIR.c <- src/characters/puff/moves/DOWNSPECIALAIR.js (M2 task 12)
// Rest: 1-frame hitbox + intangibleTimer 26; the AIR twin of DOWNSPECIALGROUND (byte-identical body); land is a comment-only body.
#include "../moves.h"
...
const MlMoveDef puff_DOWNSPECIALAIR = {"DOWNSPECIALAIR", pf_init, pf_main, pf_interrupt,
                             pf_land};
