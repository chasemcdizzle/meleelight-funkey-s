// DOWNSMASH.c <- src/characters/falcon/moves/DOWNSMASH.js (M2 task 10)
// Double-hit dsmash1/dsmash2 with randomShout + normalswing1 at 19.
// The checkFor block keeps fox's checkForTiltTurn/abs>0.3 tail forms and
// the !inCSS gate.
#include "../moves.h"
...
const MlMoveDef falcon_DOWNSMASH = {"DOWNSMASH", fc4_init, fc4_main,
                                    fc4_interrupt, 0};
