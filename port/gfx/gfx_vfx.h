...
// Drop every live vfx instance and return how many there were. For the ONE
// caller that has a match it is throwing away: #29/#30's resume, which sets a
// match up fresh and then writes the played state over it. See gfx_vfx.c.
